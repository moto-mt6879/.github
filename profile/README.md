## AOSP development for the Motorola Edge 40 Neo & Edge 2023
...
### Device-specific repositories for aion
* [**Device Tree**](https://github.com/moto-manaus/device_motorola_aion) (`device_motorola_aion`)
* [**Device Kernel (Compiled outputs from kernel source)**](https://github.com/moto-manaus/device_motorola_aion-kernel) (`device_motorola_aion-kernel`)
* [**Vendor Tree**](https://codeberg.org/rexix01/vendor_motorola_aion) (`vendor_motorola_aion`)
...
### Device kernel repository
* [**Kernel source**](https://github.com/moto-manaus/kernel_motorola_mt6879) (`kernel_motorola_mt6879`)
